  ...
  <div>
    <template>
      <div>
        <el-row class="mr20">
          <el-col :span="24">
            <span class="float-left ml20 mt20">事件级变量</span>
          </el-col>
        </el-row>
      </div>
      <el-row>
        ...
        <el-col>
          <div class="float-left ml20">
            <el-button class="mt20" type="primary" @click="newAdd">创建事件级变量</el-button>
          </div>
          <div class="float-left ml20">
            <el-button class="mt20" type="primary" @click="delData">删除事件级变量</el-button>
          </div>
        </el-col>
      </el-row>
...
export default {
  ...
  methods: {
    newAdd() {
      ...
      this.limit = false
      this.disable = false
      this.routeName = 'addEventVariable'
    },
    closed() {
      console.log('closed======')
      this.canCommit = true
    ...
    labelCheck(index, row) {
      ...
      this.drawer = true
      this.routeName = 'checkEventVariable'
      this.getDetails()
    },
    labelUpdate(index, row) {
      ...
      this.tableForm.id = row.id
      this.drawer = true
      this.routeName = 'updateEventVariable'
      this.getDetails()
    },
    ...
    commitInfo() {
      ...
      if (this.routeName === 'addEventVariable') {
    ...
    getDetails() {
      ...
      httpService.getDetails(param).then(
        response => {
          ...
          if (this.routeName === 'checkEventVariable') {
            this.limit = true
            this.disable = true
          } else {
            this.limit = false

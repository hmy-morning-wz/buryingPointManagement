          ...
          <a-col :span="24">
            <div>
              <a-tabs @change="topTabChange" :activeKey="activeKey">
                          ...
                          <a-row type="flex">
                            <a-col v-for="(indexItem, index) in indexList" :key="index" :span="6">
                              <a-row style="position: relative;">
                                ...
                                <a-col :span="24">
                                  <div class="flex" style="margin-top:8px;margin-bottom:17px;">
                                ...
                                <div
                                  ...
                                  style="position:absolute;width:1px;height:197px;background:rgba(233,233,233,1);"
                                ></div>
                              </a-row>
                            </a-col>
                          </a-row>
                    ...
                    <div class="content" style="magin-top:24px;background: rgba(240, 242, 245, 1);">
                      ...
                      >
                        <div style="border-radius:2px;">
                          <a-row>
                            <a-col :span="24">
                              <BaojiAppProductAnalysisAll :id="productId" :eventId="eventId"></BaojiAppProductAnalysisAll>
                              <!-- <a-tabs defaultActiveKey="1">
                                <a-tab-pane tab="全部" key="1">
                                  <AppProductAnalysisAll :id="productId" :eventId="eventId"></AppProductAnalysisAll>
                                </a-tab-pane>
                ...
                <!-- forceRender -->
                <a-tab-pane tab="留存分析" key="2">
                  <PreserveAnalysis :id="productId" :pageTitle="pageTitle"></PreserveAnalysis>
                </a-tab-pane>
                <!-- <a-tab-pane tab="自定义分析" key="3">Content of Tab Pane 3</a-tab-pane> -->
              </a-tabs>
            </div>
          </a-col>
        </a-row>
...
import BaojiAppProductAnalysisAll from "../../components/baojiAppProductAnalysisAll";

import PreserveAnalysis from "../../components/preserveAnalysis";
...
export default {
  data() {
    return {
      ...
      searchParams: {
        productId: null,
        indexCodes:"baoji_start_num,baoji_active_utd,baoji_active_user,baoji_add_user",
        date: ""
      },
      activeKey: "1",

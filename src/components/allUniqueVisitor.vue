    ...
    <div style="background:rgba(255,255,255,1); ">
      <a-row>
        ...
        <a-col style="padding-top:30px;padding-bottom:100px;" :span="24">
          <div v-show="!columnar" id="allUniqueData" style="margin-right:24px;margin-top:24px;"></div>
          <div v-show="columnar" id="colUniqueData" style="margin-right:24px;margin-top:24px;"></div>
...
export default {
  ...
  created() {
    ...
    this.searchParams.indexCode = "visit_num";

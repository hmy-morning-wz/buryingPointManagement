<template>
  <div class="contain_bg">
    <div style="background:rgba(255,255,255,1); ">
      <a-row>
        <a-col :span="24">
          <span class="title-name">指标趋势</span>
          <a-button style="float:right;" @click="downLoad(2)">导出数据</a-button>
          <a-range-picker
      ...
      <a-row style="margin-top:24px;padding-bottom:24px;">
        <a-col :span="24" style="padding-bottom:24px;">
          <span class="title-name1">详细数据</span>
          <!-- <a-range-picker
            :defaultValue="[moment(defaultStartDay, dateFormat), moment(yesterDay, dateFormat)]"
            :disabledDate="disabledEndDate"
      ...
      <a-row style="margin-top:24px;padding-bottom:24px;">
        <a-col :span="24" style="padding-bottom:24px;">
          <span class="title-name">首页点击</span>
          <a-button style="float:right;" @click="downTable">导出数据</a-button>
          <a-range-picker
            style="float:right;margin-right:20px;"
...
export default {
  ...
  created() {
    ...
    this.defaultStartDay2 =
      defaultStartDay2.getFullYear() +
      "-" +
    ...
    this.searchParams.indexCode = "baoji_start_num";
    ...
    this.searchParams3.indexCode =
      "baoji_start_num,baoji_active_utd,baoji_active_user,baoji_add_user,baoji_user_all";
  ...
  methods: {
    ...
    handleTargetChange(value) {
      ...
      if (value === 5) {
        this.searchParams.indexCode = "baoji_user_all";
      } else if (value === 1) {
        this.searchParams.indexCode = "baoji_start_num";
      } else if (value === 2) {
        this.searchParams.indexCode = "baoji_active_utd";
      } else if (value === 3) {
        this.searchParams.indexCode = "baoji_active_user";
      } else if (value === 4) {
        this.searchParams.indexCode = "baoji_add_user";
      } else {
        this.searchParams.indexCode = "baoji_user_all";
      }
      this.getAllData(this.searchParams, 1);
      ...
      httpService.getEventDetails(param).then(
        response => {
          ...
          if (this.tableForm.startDay && this.tableForm.endDay) {
            console.log(
              "startDay====",
              this.tableForm.startDay + "=====" + this.tableForm.endDay
            );
            this.tableForm.startDay = this.defaultStartDay2.replace(/-/g, "");
            this.tableForm.endDay = this.today.replace(/-/g, "");
          ...
          if (+response.code === 200 && response.data) {
            if (response.data.records instanceof Array) {
              ...
              for (let index = 0; index < keys.length; index++) {
                ...
                if (element === "mtr_group") {
                  title = "模块";
                }
                if (element === "mtr_index") {
                  title = "位置";
                }

                // for (let index = 0; index < this.deminOptions.length; index++) {
              ...
              for (let index = 0; index < this.tableData.length; index++) {
                ...
                if (element.mtr_index != "-") {
                  element.mtr_index = ~~element.mtr_index +1
                } 
              }
    ...
    onRangeChange(date, dateString) {
      ...
      this.searchParams3.startDay = dateString[0].replace(/-/g, "");
      this.searchParams3.endDay = dateString[1].replace(/-/g, "");
